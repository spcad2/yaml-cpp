...
class SupportConan(ConanFile):
    ...
    license = "MIT"
    # [conan 2.0] package_type = "static-library"
...
#        #get(self, **self.conan_data["sources"][self.version], strip_root=True)
        self.run("git clone https://github.com/spcad2/yaml-cpp.git .")

#'CMakeToolchain' generator only works with CMake >= 3.15
    def generate(self):
